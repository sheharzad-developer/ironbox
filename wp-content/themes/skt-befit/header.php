...
<div class="topfirstbar">
	<div class="topbarleft">
		<div class="email-top"> 
        <?php if( '' !== get_theme_mod('contact_mail')){ ?><a href="mailto:<?php echo sanitize_email(get_theme_mod('contact_mail')); ?>"><?php echo get_theme_mod('contact_mail'); ?></a><?php } ?></div>
 
        <div class="social-top social"><?php if ( '' !== get_theme_mod( 'fb_link' ) ) { ?>
    ...
    <div class="topbarright">
     ...
     <?php if ( '' !== get_theme_mod( 'contact_no' ) ){  ?>
        ...
        <div class="header-inner header">
            ...
            <div class="mobile_nav"><a href="#"><?php _e('Go To...','skt-befit'); ?></a></div>
            <div class="site-nav">
...
if(!empty($id_arr)){ ?> 
    ...
    <div id="slidecaption<?php echo $i; ?>" class="nivo-html-caption">
      <div class="slide_info">
        ...
        <div class="clear"></div>
        <div class="slide_more"><a href="<?php the_permalink(); ?>"><?php esc_attr_e('Train With Amanda','skt-befit');?></a></div>
      </div>
    </div><?php $i++; } ?>
  </div>
  <div class="clear"></div>
...
<section id="home_slider">
  <div class="slider-wrapper theme-default">
    ...
    <div class="nivo-html-caption" id="slidecaption1">
      <div class="slide_info">
        <h1><?php esc_attr_e('Be Always Stay Fit','skt-befit');?></h1>
        <p><?php esc_attr_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis malesuada ex non magna convallis aliquam. Nulla ullamcorper elit a ante ullamcorper, nec malesuada massa commodo. In ut nisi nisl. Nullam porta fringilla purus, quis mollis enim tincidunt ut. Praesent vitae lacus ligula.','skt-befit');?></p>
        <div class="clear"></div>
        <div class="slide_more"><a href="<?php esc_url('#');?>"><?php esc_attr_e('Train With Amanda','skt-befit');?></a></div>
      </div>
    </div>
    <div class="nivo-html-caption" id="slidecaption2">
      <div class="slide_info">
        <h1><?php esc_attr_e('Fitness Health And Wellbeing','skt-befit');?></h1>
        <p><?php esc_attr_e('Morbi faucibus nisi elit, vitae volutpat ante condimentum eu. Phasellus a mauris luctus, ullamcorper tortor vitae, tristique nulla. In sed est ut purus bibendum tempor sit amet vel orci.','skt-befit');?></p>
        <div class="clear"></div>
        <div class="slide_more"><a href="<?php esc_url('#');?>"><?php esc_attr_e('Train With Amanda','skt-befit');?></a></div>
      </div>
    </div>
    <div class="nivo-html-caption" id="slidecaption3">
      <div class="slide_info">
        <h1><?php esc_attr_e('Get In Shape With Exercise','skt-befit');?></h1>
        <p><?php esc_attr_e('Morbi faucibus nisi elit, vitae volutpat ante condimentum eu. Phasellus a mauris luctus, ullamcorper tortor vitae, tristique nulla. In sed est ut purus bibendum tempor sit amet vel orci.','skt-befit');?></p>
        <div class="clear"></div>
        <div class="slide_more"><a href="<?php esc_url('#');?>"><?php esc_attr_e('Train With Amanda','skt-befit');?></a></div>
      </div>
...
<div class="feature-box-main site-aligner">
  ...
  <div class="feature-box"> <a href="<?php the_permalink(); ?>">
    ...
    <span></span> <?php echo wp_kses_post(sktbefit_content(30)); ?> </a><a class="read-more" href="<?php the_permalink(); ?>">
